...
World News Stream : Kafka, ML Inference, Python, Cluster Handling , Nginx, FastAPI, Streamlit, API Gateway, ECR, Airflow , Zookeeper, pySpark Cluster over Hadoop, RDB, Jenkins, GitOps, Grafana, Prometheus
